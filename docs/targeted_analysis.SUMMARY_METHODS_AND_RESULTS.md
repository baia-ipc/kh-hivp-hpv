...
The results of this step are in tables (TSV) under outs/targeted_analysis/01.bucketing/reports
...
(see e.g. outs/targeted_analysis/01.bucketing/HPV_11092024/krona/KHCA-229.krona.html)

# Strain assignment

The results are reported in outs/targeted_analysis/02.mapping_vs_pave/reports/strains.tsv
and summarized here:
...
The results are found in outs/targeted_analysis/03.variant_analysis/reports/E6_E7_variants.tsv and summarized here.
