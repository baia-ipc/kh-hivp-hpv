# preliminary-analysis-all-patients step 001: Centrifuge bucketing
...
- The same pipelines are also reused for `targeted-analysis-hpv16-hpv18/001.0.bucketing/` with a
