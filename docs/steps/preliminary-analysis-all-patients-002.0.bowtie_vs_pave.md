# preliminary-analysis-all-patients step 002: Bowtie vs PAVE
...
- Step path config: `bin/config/preliminary-analysis-all-patients_002.bowtie_vs_pave.config` (internal defaults)
