...
- Step path config: `bin/config/preliminary-analysis-all-patients.config` (profile `preliminary_bowtie_vs_pave`)
...
- `bin/preliminary-analysis-all-patients.steps/002.0.bowtie_vs_pave.run.sh` (all samples)
- `bin/preliminary-analysis-all-patients.steps/single_sample/002.0.bowtie_vs_pave.run_sample.sh` (single sample pair)
