# prelim_analysis step 005: PAVE E7 mapping
...
- `bin/prelim_analysis.steps/005.0.bowtie_vs_pave.E7.run.sh` (all samples)
- `bin/prelim_analysis.steps/single_sample/005.0.bowtie_vs_pave.E7.run_sample.sh` (single sample pair)
