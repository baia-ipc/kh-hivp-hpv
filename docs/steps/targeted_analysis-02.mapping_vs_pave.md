...
- PAVE reference inputs (wired via `config/pipelines/bowtie_vs_pave.config`):
  ...
  - BED directory: `intermediate_files/refdata/pave/bed` (generated from GFF3 with `scripts/pave/gff3_to_bed.run_all.sh`, or auto-generated by the pipeline)
  - Feature tables (derived): `intermediate_files/refdata/pave/features_tsv` (generated from GFF3 with `scripts/pave/gff3_to_features_tsv.run_all.sh`, or auto-generated by the pipeline)
