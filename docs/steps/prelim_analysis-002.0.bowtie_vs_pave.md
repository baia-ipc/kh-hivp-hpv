# prelim_analysis step 002: Bowtie vs PAVE
...
- `bin/prelim_analysis.steps/002.0.bowtie_vs_pave.run.sh` (all samples)
- `bin/prelim_analysis.steps/single_sample/002.0.bowtie_vs_pave.run_sample.sh` (single sample pair)
