# targeted-analysis-hpv16-hpv18 step 002: Bowtie vs PAVE

## Overview

This step maps bucketed reads (from targeted-analysis-hpv16-hpv18 step 001) to the PAVE
...
- Step path config: `bin/config/targeted-analysis-hpv16-hpv18_002.mapping_vs_pave.config` (internal defaults)
...
- Reads directory: output of targeted-analysis-hpv16-hpv18 step 001 (`targeted-analysis-hpv16-hpv18/001.0.bucketing/output/`)
