# prelim_analysis step 02: Bowtie vs PAVE
...
- `bin/prelim_analysis.steps/02.bowtie_vs_pave.run.sh` (all samples)
- `bin/prelim_analysis.steps/single_sample/02.bowtie_vs_pave.run_sample.sh` (single sample pair)
