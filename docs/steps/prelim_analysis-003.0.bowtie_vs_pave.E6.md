# prelim_analysis step 003: PAVE E6 mapping
...
- `bin/prelim_analysis.steps/003.0.bowtie_vs_pave.E6.run.sh` (all samples)
- `bin/prelim_analysis.steps/single_sample/003.0.bowtie_vs_pave.E6.run_sample.sh` (single sample pair)
