...
- Outgroup list: `metadata/hpv18_tree/hpv18_tree_outgroups.txt`
...
The selected NCBI accessions are listed in `metadata/hpv18_tree/hpv18_tree_db_selection.txt`.

## Outputs

- Tree outputs and intermediate artifacts under `outs/targeted_analysis/05.hpv18_tree/`
- MultiQC report: `results/reports/targeted_analysis/05_hpv18_tree.report.html`
