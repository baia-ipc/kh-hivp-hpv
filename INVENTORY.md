...
- `config/`: bowtie_vs_pave.config, bowtie_vs_pave.env.yml, centrifuge_bucketing.config, centrifuge_bucketing.env.yml, nextflow_java.env.yml, pave_e6.config, pave_gene_mapping.env.yml, virstrain.config, virstrain.env.yml
