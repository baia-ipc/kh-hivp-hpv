...
- `analysis-input1/002.0.bowtie_vs_pave/scripts`: run.sh, run_all.sh, create-index.sh, identify_top_strains.py, covstats.py, covplot.py, aggregate_covstats.py, make_all_covplots.sh, report_E6_E7_variants.sh, README.md
- `analysis-input1/003.0.virstrain/scripts`: run.sh, run_all.sh, create-index.sh, fix_msa_formatting.py, aggregate_results.py, README.md
...
- `analysis-input2/002.0.mapping_vs_pave/scripts`: run.sh, run_all.sh, create-index.sh, identify_top_strains.py, covstats.py, covplot.py, aggregate_covstats.py, make_all_covplots.sh, report_E6_E7_variants.sh, README.md
...
- `config/`: centrifuge_bucketing.config, centrifuge_bucketing.env.yml, nextflow_java.env.yml
...
- `analysis-input1/003.0.virstrain/scripts/README.md`: no manual commands (docs only).
- `analysis-input1/002.0.bowtie_vs_pave/scripts/README.md`: create bowtie2 index; align with `bowtie --all`; count with `samtools idxstats`; run rough strain assignment script.
- `analysis-input2/002.0.mapping_vs_pave/scripts/README.md`: same as above (create index, bowtie --all, samtools idxstats, rough strain assignment).
