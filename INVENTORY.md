...
- `config/`: bowtie_vs_pave.config, bowtie_vs_pave.env.yml, centrifuge_bucketing.config, centrifuge_bucketing.env.yml, centrifuge_bucketing.multiqc.yml, hpv16_tree.config, hpv18_tree.config, nextflow_java.env.yml, pave_e6.config, pave_e7.config, pave_gene_mapping.env.yml, phylo_tree.env.yml, virstrain.config, virstrain.env.yml
