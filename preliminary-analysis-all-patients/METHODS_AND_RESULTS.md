# Methods and Results — preliminary-analysis-all-patients step 001 (centrifuge bucketing)
...
- Counts and proportions are from:
  - `preliminary-analysis-all-patients/001.0.centrifuge/reports/absolute_counts.tsv`
  - `preliminary-analysis-all-patients/001.0.centrifuge/reports/relative_counts.tsv`
  - `preliminary-analysis-all-patients/001.0.centrifuge/reports/relative_counts.wo_human.tsv`
- Relative abundance summaries above use the human‑excluded table.

# Methods and Results — preliminary-analysis-all-patients step 002 (bowtie vs PAVE mapping)
...
**Notes on sources**
- `preliminary-analysis-all-patients/002.0.bowtie_vs_pave/reports/strains.tsv`
- `preliminary-analysis-all-patients/002.0.bowtie_vs_pave/reports/cov_stats.tsv`
- `preliminary-analysis-all-patients/002.0.bowtie_vs_pave/reports/cov_stats.filtered.tsv`
- `preliminary-analysis-all-patients/002.0.bowtie_vs_pave/reports/E6_E7_variants.tsv`
- `preliminary-analysis-all-patients/002.0.bowtie_vs_pave/reports/E6_E7_variant_effects.tsv`

# Methods and Results — preliminary-analysis-all-patients step 003 (VirStrain)
...
**Notes on sources**
- `preliminary-analysis-all-patients/003.0.virstrain/reports/strains.tsv`

# Methods and Results — preliminary-analysis-all-patients step 004 (bowtie vs PAVE E6)
...
**Notes on sources**
- `preliminary-analysis-all-patients/004.0.bowtie_vs_pave.E6/reports/strains.tsv`
- `preliminary-analysis-all-patients/004.0.bowtie_vs_pave.E6/reports/depth_stats.unfiltered.tsv`
- `preliminary-analysis-all-patients/004.0.bowtie_vs_pave.E6/reports/depth_stats.filtered.tsv`

# Methods and Results — preliminary-analysis-all-patients step 005 (bowtie vs PAVE E7)
...
**Notes on sources**
- `preliminary-analysis-all-patients/005.0.bowtie_vs_pave.E7/reports/strains.tsv`
- `preliminary-analysis-all-patients/005.0.bowtie_vs_pave.E7/reports/depth_stats.unfiltered.tsv`
- `preliminary-analysis-all-patients/005.0.bowtie_vs_pave.E7/reports/depth_stats.filtered.tsv`
