...
- Outputs:
  - analysis-input1: `analysis-input1/steps/001.0.centrifuge/output` and `reports`
  - analysis-input2: `analysis-input2/steps/001.0.bucketing/output` and `reports`

## Skill: bowtie vs PAVE mapping and reports

- Scope: mapping and rough strain assignment.
- Locations:
  - analysis-input1: `analysis-input1/steps/002.0.bowtie_vs_pave`
  - analysis-input2: `analysis-input2/steps/002.0.mapping_vs_pave`
...
- Location: `analysis-input1/steps/003.0.virstrain`.
- Inputs: bucketed FASTQs from `analysis-input1/steps/001.0.centrifuge/output`.
...
- Locations:
  - `analysis-input1/steps/004.0.bowtie_vs_pave.E6`
  - `analysis-input1/steps/005.0.bowtie_vs_pave.E7`
...
- Locations:
  - `analysis-input2/steps/003.0.hpv16_tree`
  - `analysis-input2/steps/004.0.hpv18_tree`
