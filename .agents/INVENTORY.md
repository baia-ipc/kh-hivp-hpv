...
- `bin/`: step runner scripts (001.0.centrifuge.run.sh, 002.0.bowtie_vs_pave.run.sh, 003.0.virstrain.run.sh, 004.0.bowtie_vs_pave.E6.run.sh, 005.0.bowtie_vs_pave.E7.run.sh, 001.0.bucketing.run.sh, 002.0.mapping_vs_pave.run.sh, 003.0.hpv16_tree.run.sh, 004.0.hpv18_tree.run.sh, 005.0.cambodia_snps.run.sh) + analysis-level runners (analysis-input1.run.sh, analysis-input2.run.sh) and single-sample wrappers under `bin/sample/`
...
- `config/`: bowtie_vs_pave.config, cambodia_snps.config, centrifuge_bucketing.config, hpv16_tree.config, hpv18_tree.config, pave_bucket_tid.txt, pave_gene_mapping.config, phylo_tree.config, virstrain.config
- `bin/config/`: analysis-input1_001.centrifuge.config, analysis-input1_002.bowtie_vs_pave.config, analysis-input1_003.virstrain.config, analysis-input2_001.bucketing.config, analysis-input2_002.mapping_vs_pave.config, analysis-input2_003.hpv16_tree.config, analysis-input2_004.hpv18_tree.config, analysis-input2_005.cambodia_snps.config, pave_e6.config, pave_e7.config
- `pipelines/config/`: bowtie_vs_pave.technical.config, cambodia_snps.technical.config, centrifuge_bucketing.technical.config, common.technical.config, pave_gene_mapping.technical.config, phylo_tree.technical.config, phylo_tree.hpv16.technical.config, phylo_tree.hpv18.technical.config, virstrain.technical.config
