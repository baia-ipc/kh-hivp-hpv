...
- `config/`: bowtie_vs_pave.config, cambodia_snps.config, centrifuge_bucketing.config, hpv16_tree.config, hpv18_tree.config, pave_gene_mapping.config, phylo_tree.config, virstrain.config
