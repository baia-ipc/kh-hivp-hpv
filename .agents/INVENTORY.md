...
- `bin/config/`: preliminary-analysis-all-patients_001.centrifuge.config, preliminary-analysis-all-patients_002.bowtie_vs_pave.config, preliminary-analysis-all-patients_003.virstrain.config, targeted-analysis-hpv16-hpv18_001.bucketing.config, targeted-analysis-hpv16-hpv18_002.mapping_vs_pave.config, targeted-analysis-hpv16-hpv18_003.hpv16_tree.config, targeted-analysis-hpv16-hpv18_004.hpv18_tree.config, targeted-analysis-hpv16-hpv18_005.snps_samples_vs_db.config, pave_e6.config, pave_e7.config
- `pipelines/config/`: bowtie_vs_pave.config, cambodia_snps.config, centrifuge_bucketing.config, common.config, pave_gene_mapping.config, phylo_tree.config, phylo_tree.hpv16.config, phylo_tree.hpv18.config, virstrain.config
