...
- Outputs: alignment and tree artifacts under each step directory, plus `reports/phylo_tree.svg` (PNG fallback) and `reports/phylo_tree_summary.multiqc.tsv`. MultiQC reports land under `results/multiqc/targeted_analysis/`.
