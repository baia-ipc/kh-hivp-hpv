...
if __name__ == "__main__":
    ...
    default_refs = repo_root / "metadata" / "hpv18_lineage_refs.tsv"
    default_outgroups = repo_root / "metadata" / "hpv18_tree_outgroups.txt"

    parser = argparse.ArgumentParser(
        description="Assign HPV18 lineages by distance to reference tips."
    )
